...
begin
  if ClassTributaria in [cst30, cst40, cst41, cst50, cst60, csosn101, csosn102,
                         csosn103, csosn201, csosn202, csosn203, csosn300,
                         csosn400, csosn500, csosn900] then
    Result := 0
  else
  begin
...
begin
  if ClassTributaria in [cst00, cst20, cst40, cst41, cst50, cst51,csosn101,
                         csosn102, csosn103, csosn201, csosn202, csosn203,
                         csosn300, csosn400, csosn500, csosn900] then
    Result := 0
  else
...
begin
  ...
  begin
    lAliq := TEstados.AliquotaInterEstadual(NotaFiscal.DestinatarioNF.Estado);
