...
uses Windows, IdHashMessageDigest, idHash, classes, SysUtils;
...
function MD5_Str(const texto: string): string;
// -----------------------------------------------------------------------------------------------
IMPLEMENTATION
// -----------------------------------------------------------------------------------------------
...
function MD5_Str(const texto: string): string; //extrai o MD5 da string
var
   idmd5: TIdHashMessageDigest5;
begin
      idmd5 := TIdHashMessageDigest5.Create;
...
begin
  Result := '';
  for I := 0 to 15 do Result := Result + AnsiString(Digits[(D[I] shr 4) and $0f] + Digits[D[I] and $0f]);
end;
